...
if(WIN32)
	...
	ExternalProject_Add(
		...
		CMAKE_ARGS 
			...
			-DOSGBULLET_BUILD_EXAMPLES=OFF
			-DOSGBULLET_INSTALL_DATA=OFF
			# Bullet (Set library paths manually, the default cmake/osgBullet 
			# scripts do not seem to work wen the libraries do not end up being in 
			# bullet-build/lib
			-DBulletInstallType:STRING=${BulletInstallType}
			-DBulletSourceRoot:PATH=${CMAKE_BINARY_DIR}/src/bullet-prefix/src/bullet
			#-DBulletBuildRoot:PATH=${CMAKE_BINARY_DIR}/src/bullet-prefix/src/bullet-build
			-DBULLET_DYNAMICS_LIBRARY:PATH=${CMAKE_BINARY_DIR}/src/bullet-prefix/src/bullet-build/src/BulletDynamics/libBulletDynamics.a
			-DBULLET_COLLISION_LIBRARY:PATH=${CMAKE_BINARY_DIR}/src/bullet-prefix/src/bullet-build/src/BulletCollision/libBulletCollision.a
			-DBULLET_MATH_LIBRARY:PATH=${CMAKE_BINARY_DIR}/src/bullet-prefix/src/bullet-build/src/LinearMath/libLinearMath.a
			-DBULLET_SOFTBODY_LIBRARY:PATH=${CMAKE_BINARY_DIR}/src/bullet-prefix/src/bullet-build/src/BulletSoftBody/libBulletSoftBody.a
#----------
